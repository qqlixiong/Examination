...
public class InteractionClassroomView extends BaseRecommendView{
    public InteractionClassroomView(Context context) {
        super(context);
    }

    public InteractionClassroomView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public InteractionClassroomView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onClicked() {
        ...
        IntentUtil.startActivity(context,InteractionClassroomActivity.class,bundle);
    }
}
